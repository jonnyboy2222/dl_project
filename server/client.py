...
class UdpSenderThread(QThread):
    ...
    def run(self):
        ...
        while self.running:
            ...
            self.uuid_counter += 1
            uuid_msg = json.dumps({"uuid": self.uuid_counter}).encode('utf-8')
...
class WindowClass(QMainWindow, from_class):
    def __init__(self):
        ...
        self.tcp_client.msg_lane.connect(self.update_lane_msg)
        self.tcp_client.msg_obj.connect(self.update_obj_msg)
